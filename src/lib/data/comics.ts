...
export const comics: Comic[] = [
  {
    ...
    author: 'Alex Chen',
    cover_url: '/dark-fantasy-comic-cover-with-mysterious-shadows.jpg',
  ...
  },
  {
    ...
    cover_url: '/cyberpunk-romance-comic-cover-with-neon-lights.jpg',
  ...
  },
  {
    ...
    author: 'Kenji Tanaka',
    cover_url: '/martial-arts-fantasy-comic-cover-with-blue-energy.jpg',
  ...
  },
  {
    ...
    cover_url: '/horror-mystery-comic-cover-with-dark-void.jpg',
  ...
  },
  {
    ...
    author: 'Emma Park',
    cover_url: '/cozy-cafe-slice-of-life-comic-cover.jpg',
  ...
  },
  {
    ...
    title: 'Crimson Blade',
    author: 'Marcus Stone',
    cover_url: '/samurai-action-comic-cover-with-red-sword.jpg',
...
export const chapters: Record<string, Chapter[]> = {
  '1': Array.from({ length: 45 }, (_, i) => ({
    ...
    comicId: '1',
    chapterNumber: i + 1,
    title: i === 0 ? 'The Awakening' : i === 44 ? 'Into the Abyss' : `Chapter ${i + 1}`,
    pages: Array.from(
      { length: 25 },
      (_, j) => `/placeholder.svg?height=1400&width=800&query=dark fantasy comic page ${j + 1}`,
    ),
  ...
  '2': Array.from({ length: 32 }, (_, i) => ({
    ...
    comicId: '2',
    chapterNumber: i + 1,
    title: i === 0 ? 'First Contact' : i === 31 ? 'Digital Hearts' : `Chapter ${i + 1}`,
    pages: Array.from(
      { length: 22 },
      (_, j) =>
        `/placeholder.svg?height=1400&width=800&query=cyberpunk romance comic page ${j + 1}`,
    ),
...
export function getChapterById(comicId: string, chapterId: string): Chapter | undefined {
